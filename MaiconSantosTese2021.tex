...
\title{ da Adoção de Infraestruturas de Nuvem no Desenvolvimento de Pesquisas Acadêmicas}
...
do nó de computação, foram levadas em consideração tecnologias atuais de mercado, com base em produtos ofertados pelos principais fabricantes de hardware. A solução de nuvem computacional federada

...
\begin{inparaenum}[]
	\item \textbf{\emph{a}}: é o instante de tempo no qual o conjunto de tarefas chega para o processamento;
	\item \textbf{\emph{d}}: é o tempo de duração do grupo de tarefas;
	\item \textbf{\emph{b}}: é a quantidade de tarefas descritas por quádrupla correspondente; e
	\item \textbf{\emph{c}}: é a taxa de utilização de CPU para cada tarefa da quádrupla. O valor informado para o custo deve estar entre 1 e 100, indicando o percentual de uso da CPU de cada uma das tarefas quando em execução.
\end{inparaenum}

...
Para definição das especificações técnicas do nó de computação (ou conjunto de equipamentos) padrão, que será disponibilizado para as Instituições de Ensino e Pesquisa, foi levado em consideração tecnologias atuais de mercado

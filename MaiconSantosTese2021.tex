...
A definição das especificações técnicas do nó de computação se deu a partir de avaliações feitas sobre tecnologias atuais de mercado, com base em produtos ofertados pelos principais fabricantes de hardware. A solução de nuvem computacional federada contará com dois módulos: básico e HPC. O módulo básico será composto por equipamentos de processamento, armazenamento e conexão ao passo que o módulo HPC contará com recursos de processamento e adicionará, ao módulo básico, quantidades de armazenamento à medida que são incorporadas mais unidades, do módulo HPC, à solução de nuvem instalada na Instituição.

...
Os fluxos de trabalho científicos (\emph{workflows}) estão presentes em diversos domínios de aplicação e pesquisa, como por exemplo, astronomia, biologia, física gravitacional, estudos de terremotos, entre outros.
...
\cite{deelmanPegasusCloudScience2016}\\
...
\begin{figure}[H]
	\centerline{
		\includegraphics[scale=0.25]{images/sipht.png}}
	\caption[SIPHT workflow]{SIPHT workflow \cite{juveCharacterizingProfilingScientific2013}.}
	\label{sipht}
\end{figure}
